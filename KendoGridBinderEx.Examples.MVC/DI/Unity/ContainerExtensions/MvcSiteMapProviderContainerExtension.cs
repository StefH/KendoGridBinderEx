...
namespace KendoGridBinderEx.Examples.MVC.DI.Unity.ContainerExtensions
{
        ...
        : UnityContainerExtension
    {
        protected override void Initialize()
        {
            ...
            var includeAssembliesForScan = new[] { "KendoGridBinderEx.Examples.MVC" };
            ...
            Container.RegisterType<IControllerBuilder, ControllerBuilderAdaptor>(new PerResolveLifetimeManager());

            Container.RegisterType<IBuildManager, BuildManagerAdaptor>(new PerResolveLifetimeManager());
            ...
            Container.RegisterInstance<System.Runtime.Caching.ObjectCache>(System.Runtime.Caching.MemoryCache.Default);
            Container.RegisterType(typeof(ICacheProvider<>), typeof(RuntimeCacheProvider<>));
            Container.RegisterType<ICacheDependency, RuntimeFileCacheDependency>("cacheDependency", new InjectionConstructor(absoluteFileName));
            ...
            Container.RegisterType<ISiteMapXmlReservedAttributeNameProvider, SiteMapXmlReservedAttributeNameProvider>(new InjectionConstructor(new List<string>()));
            ...
            Container.RegisterType<ISiteMapBuilderSetStrategy, SiteMapBuilderSetStrategy>(new InjectionConstructor(new ResolvedArrayParameter<ISiteMapBuilderSet>(new ResolvedParameter<ISiteMapBuilderSet>("builderSet1"))));
        }
    }
}